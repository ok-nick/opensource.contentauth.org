...
- Executing a shell command to invoke c2patool. For an example, see the [c2patool Node.js service example](https://opensource.contentauthenticity.org/docs/c2pa-service-example/).
