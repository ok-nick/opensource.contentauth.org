...
**Asset**: A digital media file or stream of data. Right now, this means [certain specific types](https://opensource.contentauthenticity.org/docs/c2patool/#supported-file-formats) of image, video, or audio files, but the types of supported assets will expand in the future. A _composed asset_ generalizes this concept, for example for an image superimposed on top of another image.
...
:::tip
For more details and a short tutorial example, see [Signing manifests](signing-manifests/).
:::
