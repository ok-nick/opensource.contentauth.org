...
### Is Content Credentials alone sufficient to prevent the spread of misinformation.

<FaqAnswer>

The most effective approach to content provenance is a combination of technologies and practices, including secure metadata, undetectable watermarks, and content fingerprinting.
Together, these approaches can make the metadata durable, or able to persist in the face of screenshots and rebroadcast attacks.

This "three-pronged" approach includes:

- **Secure metadata**: Verifiable information about how content was made that is baked into the content itself, in a way that cannot be altered without leaving evidence of alteration. A Content Credential can indicate the provenance of any digital media asset and indicate how content may have been altered, what content was combined to produce the final content, and even what device or software was involved in each stage of production.
- **Watermarking**: Although this term is often used generically to refer to data that is permanently attached to content and hard or impossible to remove, here, it refers to hidden information undetectable by humans but that can be decoded using a watermark detector. State-of-the-art watermarks can be impervious to alterations such as cropping or rotating or the addition of noise to video and audio. Importantly, the strength of a watermark is that it can survive rebroadcasting efforts like screenshotting, pictures of pictures, or re-recording of media, which effectively remove secure metadata.
...
For more information, see the blog post from April 8, [Durable Content Credentials](https://contentauthenticity.org/blog/durable-content-credentials).
