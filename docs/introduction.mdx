...
The CAI open-source SDK is a set of tools and libraries that enable developers to create, verify, and display Content Credentials based on C2PA standards.
...
The CAI open-source SDK (software development kit) consists of:

- [C2PA Tool](#c2pa-tool): a command-line tool for working with C2PA manifests and media assets (audio, image or video files).
