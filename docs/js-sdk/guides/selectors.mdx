...
For instance, you can use [`selectProducer`](https://github.com/contentauth/c2pa-js/blob/main/packages/c2pa/src/selectors/selectProducer.ts) to get information on the producer of an asset as follows:
