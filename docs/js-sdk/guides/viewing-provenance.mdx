...
If the input provided to [`c2pa.read`](../../js-sdk/api/c2pa.c2pa#methods) has a C2PA manifest and was processed without errors, the returned [`c2paReadResult`](../../js-sdk/api/c2pa.c2pareadresult) will contain a [`manifestStore`](../../js-sdk/api/c2pa.c2pareadresult.manifeststore).
