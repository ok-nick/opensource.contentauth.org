...
Examples for common build systems are shown below. They are also available in the [`examples` directory](https://github.com/contentauth/c2pa-js/tree/main/examples) in the [c2pa-js-examples repository](https://github.com/contentauth/c2pa-js-examples).
