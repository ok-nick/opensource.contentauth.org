...
A new issue/task starts in the **In Review / Triage** status. Once reviewed and approved, it moves into **To Do** status, and when a developer begins working on it, into **In Progress**. Once development work is done, the task moves to **Code Complete**. After testing and validation, it moves to **Merged to Main** and finally is included in a release.
