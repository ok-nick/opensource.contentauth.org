...
To load and use these lists with the JavaScript librar (`c2pa-js`), pass them to the `read` or `readAll` functions as shown in the following TypeScript example:

<div class="review-comment">
  Do you mean `readFile`? I don't see `readAll` in the code below.
</div>
